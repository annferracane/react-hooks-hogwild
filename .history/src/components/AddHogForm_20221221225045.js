    ...
    return (
        <div className="filterWrapper">
            ...
            <form onSubmit={ onSubmitHandler }>
                ...
                <input type="text" name="specialty" placeholder="Specialty" value={ formData.specialty } onChange={ handleFormChange }/>
                <input type="checkbox" name="greased" checked={ formData.greased } onChange={ handleFormChange }/>
                <input type="text" name="highest medal achieved" placeholder="Highest Medal Achieved" value={ formData["highest medal achieved"] } onChange={ handleFormChange }/>
                <label>Greased?
